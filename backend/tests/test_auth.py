...
class TestAuthEndpoints:
    ...
    def test_check_username_exists(self, mock_get_supabase, client):
    ...
    @patch("app.routers.auth.get_supabase")
    def test_check_username_not_exists(self, mock_get_supabase, client):
    ...
    @patch("app.routers.auth.get_supabase")
    def test_check_email_exists(self, mock_get_supabase, client):
    ...
    @patch("app.routers.auth.get_supabase")
    def test_check_email_not_exists(self, mock_get_supabase, client):
    ...
    @patch("app.routers.auth.get_supabase")
    def test_create_user_success(self, mock_get_supabase, client, sample_user):
        """Test user creation"""
        mock_supabase = MagicMock()
        mock_supabase.table.return_value.insert.return_value.execute.return_value.data = [sample_user]
        mock_get_supabase.return_value = mock_supabase
    ...
    @patch("app.routers.auth.get_supabase")
    def test_get_user_by_username_found(self, mock_get_supabase, client):
    ...
    @patch("app.routers.auth.get_supabase")
    def test_get_user_by_username_not_found(self, mock_get_supabase, client):
